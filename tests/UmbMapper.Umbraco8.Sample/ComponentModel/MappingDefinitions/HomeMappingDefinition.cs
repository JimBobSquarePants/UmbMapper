...
using UmbMapper.Umbraco8.Sample.ComponentModel.PropertyMappers;
...
namespace UmbMapper.Umbraco8.Sample.ComponentModel.Mappers
{
    ...
    /// </summary>
    public class HomeMappingDefinition : PublishedPageMappingDefinition<Home>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HomeMap"/> class.
        /// </summary>
        public HomeMappingDefinition()
        {
            ...
            this.AddMappingDefinition(x => x.PostNames).SetAlias(x => x.Posts).SetMapper<NamePickerPropertyMapper>();
