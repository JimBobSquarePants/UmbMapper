...
using System;
using System.Web;
using UmbMapper.Umbraco8.Sample.Extensions;
using Umbraco.Web;

namespace UmbMapper.Umbraco8.Sample.Helpers
{
    /// <summary>
    ...
    public static class UrlHelpers
    {
        ...
        {
            string url = string.Empty; // new UmbracoHelper(UmbracoContext.Current).UrlAbsolute(id);
